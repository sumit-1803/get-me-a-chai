...
const Username = () => {
  ...
  return (
    <>
      ...
      <div className='payment-container flex justify-center w-full mt-12 mb-0'> {/* Added mb-0 class */}
        <div className='payment flex gap-3 w-[80%]'>
          ...
          <div className='makePayment w-1/2 bg-slate-900 p-10 text-white rounded-lg'>
            ...
            <div className='flex gap-2 flex-col'>
              ...
              <button type="button" className="text-white w-32 bg-gradient-to-br from-purple-900 to-blue-900 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2">Pay Now!</button>
            </div>
