...
const AboutPage = () => {
    return (
        <div className="animate-fadeIn flex min-h-screen justify-center flex-col items-center gap-8 text-white bg-gradient-to-br from-blue-900 via-purple-800 to-gray-900">
            <div className="font-bold flex gap-2 text-4xl sm:text-5xl items-center justify-center">
                About <span><img className="invertImg w-16 sm:w-20 md:w-24" src="https://media2.giphy.com/media/KanTM1jNrX7TgQ2d4X/giphy.gif?cid=6c09b952pfgv0n376m7hxzqa4tayg0xkrdk8zgwa1ad4unxp&ep=v1_internal_gif_by_id&rid=giphy.gif&ct=s" alt="not loading" /></span> DevSponsor
            </div>
